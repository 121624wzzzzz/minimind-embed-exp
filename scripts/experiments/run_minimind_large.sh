#!/usr/bin/env bash
# ==============================================================================
# MiniMind large experiment entrypoint.
#
# Defaults:
#   seeds:    42 123 2026
...
LOG_ROOT="${LOG_ROOT:-$ROOT/logs/minimind-large/$RUN_ID}"
...
echo "================================================================"
echo "[large-exp] start at $(date '+%F %T')"
echo "  ROOT               = $ROOT"
echo "  GPUS               = $GPUS"
echo "  SEEDS              = $SEEDS"
...
for seed in $SEEDS; do
    ...
    if [[ "$RUN_EVAL" == "1" ]]; then
        echo
        echo "[large-exp] eval seed=$seed at $(date '+%F %T')"
...
echo
echo "================================================================"
echo "[large-exp] done at $(date '+%F %T')"
echo "  log_root=$LOG_ROOT"
echo "================================================================"
